...
import '../viewmodel/ambulancerequest_viemodel.dart';
import '../viewmodel/policerequest_viewmodel.dart';

class AmbulanceRequest extends StatelessWidget {
  AmbulanceRequest({super.key});
  String email = "";
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<AmbulanceRequestModel>.reactive(
      ...
      viewModelBuilder: () => AmbulanceRequestModel(),
      builder: (context, viewModel, child) => Scaffold(
        ...
        Column(
          children: [
            ...
            FutureBuilder(
                future: viewModel.userdata.getAmbulancedata(),
                            ...
                            child: Stack(children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: Color.fromARGB(255, 50, 233, 196),
                                    width: 2,
                                  ),
                                ),
                                child: Column(
