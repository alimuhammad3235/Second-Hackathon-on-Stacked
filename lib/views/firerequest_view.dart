...
import '../viewmodel/firereq_viewmodel.dart';
import '../viewmodel/policerequest_viewmodel.dart';

class FireRequest extends StatelessWidget {
  FireRequest({super.key});
  String email = "";

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<FireRequestModel>.reactive(
      ...
      viewModelBuilder: () => FireRequestModel(),
      builder: (context, viewModel, child) => Scaffold(
        ...
        Column(
          children: [
            ...
            FutureBuilder(
                future: viewModel.userdata.getfireRequest(),
